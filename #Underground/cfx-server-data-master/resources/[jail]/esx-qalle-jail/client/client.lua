...
function JailLogin()
	...
	ESX.ShowNotification("Du musst deine Strafe noch absitzen!")
...
function UnJail()
	...
	ESX.ShowNotification("Du wurdest Freigelassen!")
end
...
function InJail()
	...
	Citizen.CreateThread(function()
		...
		while jailTime > 0 do
			...
			ESX.ShowNotification("Du musst noch " .. jailTime .. " Minuten im Knast verbringen!")
		...
		while true do
			...
			for p, v in pairs(Config.Teleports) do
				...
				if DistanceCheck <= 7.5 then
					...
					ESX.Game.Utils.DrawText3D(v, "", 0.4)
