TokoVoipConfig = {
	...
	distance = {
		3, -- Normal speech distance in gta distance units
		15, -- Whisper speech distance in gta distance units
	...
	radioKey = Keys["4"], -- Keybind used to talk on the radio
	...
	wsServer = "45.136.28.47:33250", -- Address of the websocket server
	...
	plugin_data = {
		...
		TSChannel = "[cspacer] TokoVoIP - InGame",
		TSPassword = "ingame", -- TeamSpeak channel password (can be empty)
		...
		TSChannelWait = "[cspacer]TokoVoip - Join", -- You NEED tokovoip in the wait channel name!

		-- Blocking screen informations
		TSServer = "45.136.28.47", -- TeamSpeak server address to be displayed on blocking screen
		TSChannelSupport = "┏ Support • Warteraum", -- TeamSpeak support channel name displayed on blocking screen
		TSDownload = "https://toko.underground-rp.de", -- Download link displayed on blocking screen
