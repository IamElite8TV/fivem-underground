...
m.prefix = '^6[Important Message!] '
m.suffix = '^6.'

-- You can make as many messages as you want.
-- You can use ^0-^9 in your messages to change text color.
m.messages = {   
    '^6Viele Leute wurden von einem Teamler auf dem DC gebannt was uns sehr Leid tut hier ein neuer Discord Invite : https://discord.gg/9zYxzh2 '
    '^1Viel Spass auf LosSantosRP, und Drück mal F11';
}
