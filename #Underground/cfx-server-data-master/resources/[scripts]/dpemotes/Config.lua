...
-- NOte this might cause an issue of the image getting stuck on peoples screens
	...
	MenuImage = "https://grauerdavid.de/91e9c9edc0f788bcb4327d7302212996.png",
-- You can change the menu position here
	MenuPosition = "left", -- (left, right)S
-- You can disable the Ragdoll keybinding here.
	RagdollEnabled = true,
	RagdollKeybind = 197, -- Get the button number here https://docs.fivem.net/game-references/controls/
