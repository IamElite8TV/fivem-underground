Locales['fr'] = {
  ...
  ['in_vehicle_drop'] = 'Impossible de ~r~Jeter %s dans un véhicule',
  ...
  ['accessories_no_ears'] = '~b~👕 Information :~r~ Vous ne possédez pas d\'accessoire d\'oreilles',
  ['accessories_no_glasses'] = '~b~👕 Information :~r~ Vous ne possédez pas de lunettes',
  ['accessories_no_helmet'] = '~b~👕 Information :~r~ Vous ne possédez pas de casque ou de chapeau',
  ['accessories_no_mask'] = '~b~👕 Information :~r~ Vous ne possédez pas de masque',

  ['admin_noclipon'] = '~b~🏽 Information :~g~ NoClip activé',
  ...
  -- Loadout Menu
  ['loadout_title'] = 'Gestion des ~r~Armes',
  ...
  ['wallet_job_button'] = 'Métier:~b~ %s -~p~ %s',
  ['wallet_job3_button'] = 'Organisation:~r~ %s -~p~ %s',
  ['wallet_money_button'] = 'Argent:~g~ $%s',
  ['wallet_bankmoney_button'] = 'Banque:~b~ $%s',
  ['wallet_blackmoney_button'] = 'Argent Sale:~r~ $%s',
  ['wallet_show_idcard_button'] = 'Montrer sa carte ~b~d\'identité',
  ['wallet_check_idcard_button'] = 'Regarder sa carte ~b~d\'identité',
  ['wallet_show_driver_button'] = 'Montrer son permis de ~g~conduire',
  ['wallet_check_driver_button'] = 'Regarder son permis de ~g~conduire',
  ['wallet_show_firearms_button'] = 'Montrer son permis port ~r~d\'armes',
  ['wallet_check_firearms_button'] = 'Regarder son permis port ~r~d\'armes',
  ...
  ['animation_party_title'] = '~b~Festives',
  ...
  ['animation_salute_title'] = '~g~Salutations',
  ...
  ['animation_work_title'] = '~y~Travail',
  ...
  ['animation_mood_title'] = '~o~Humeurs',
  ...
  ['animation_sports_title'] = '~w~Sports',
  ...
  ['bossmanagement_title'] = 'Gestion Entreprise:~b~ %s',
  ...
  ['bossmanagement2_title'] = 'Gestion Organisation:~r~ %s',
