...
Config.Strings = {
	ExitVehicle = "Du musst aussteigen um zu Tanken",
	EToRefuel = "Drücke ~g~E ~w~um zu Tanken",
	JerryCanEmpty = "Der Benzinkanister ist leer",
	FullTank = "Dein Tank ist voll",
	PurchaseJerryCan = "Drücke ~g~E ~w~um einen Benzinkanister zu kaufen ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Drücke ~g~E ~w~um das Tanken zu beenden",
	CancelFuelingJerryCan = "Drücke ~g~E ~w~ um das Tanken zu unterbrechen",
	NotEnoughCash = "Du hast nicht genug Geld",
	RefillJerryCan = "Drücke ~g~E ~w~ um den Benzinkanister zu befüllen ~g~$",
	NotEnoughCashJerryCan = "Du hast nicht genug Geld um den Benzinkanister zu befüllen",
	JerryCanFull = "Dein Benzinkanister ist voll",
	TotalCost = "Preis",
}

if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Drücke ~g~E ~w~zum Aufheben des Benzinkanisters"
	Config.Strings.RefillJerryCan = "Drücke ~g~E ~w~ um den Benzinkanister zu befüllen"
end
