...
Config.yakuzaStations = {
	...
	LSPD = {
		...
		Cloakrooms = {
			vector3(-1501.61, 857.28, 181.59)
		},

		Armories = {
			vector3(-1516.71, 851.97, 181.59)
		},

		Vehicles = {
			{
				Spawner = vector3(-1553.91, 874.62, 181.74),
				InsideShop = vector3(-1559.22, 865.77, 180.98),
				SpawnPoints = {
					{coords = vector3(-1550.95, 879.92, 181.32), heading = 196.11, radius = 6.0},
					{coords = vector3(-1545.91, 885.42, 181.33), heading = 196.19, radius = 6.0}
				}
			},
...
Config.CustomPeds = {
	shared = {
		...
		{label = 'yakuza Ped', maleModel = 's_m_y_cop_01', femaleModel = 's_f_y_cop_01'}
	},
